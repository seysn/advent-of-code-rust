...
fn count(line: String) -> (u32, u32) {
    line.chars().fold((0, 0), |(z, o), c| if c == '0' { (z + 1, o) } else { (z, o + 1)})
}
...
mod tests {
    ...
    #[test]
    fn example_part1() {
        assert_eq!(part1(&[String::from("00100"), String::from("11110"), String::from("10110"), String::from("10111"), String::from("10101"), String::from("01111"), String::from("00111"), String::from("11100"), String::from("10000"), String::from("11001"), String::from("00010"), String::from("01010")]), 198);
    }

    #[test]
    fn example_part2() {
        assert_eq!(part2(&[String::from("00100"), String::from("11110"), String::from("10110"), String::from("10111"), String::from("10101"), String::from("01111"), String::from("00111"), String::from("11100"), String::from("10000"), String::from("11001"), String::from("00010"), String::from("01010")]), 230);
    }
}